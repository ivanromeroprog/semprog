...
public interface TitularDAO {
     ...
     boolean insertar(String nombre, String apellido, String tipo_doc, String nro_doc, String telefono);
     
     boolean modificar(int id_titular, String nombre, String apellido, String tipo_doc, String nro_doc, String telefono);
